...
articles = Table(
    'articles', metadata,
    Column('id', Integer, primary_key=True, autoincrement=True),
    Column('date', Integer, primary_key=True, autoincrement=True),
    ...
    Column('runtime', Integer, primary_key=True, autoincrement=True),
    Column('rating', Integer, primary_key=True, autoincrement=True)
)
