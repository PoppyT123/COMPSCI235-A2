...
def test_index(client):
    ...
    assert b"Let's watch some movies! Browse by Genre" in response.data
...
def test_comment(client, auth):
    ...
    assert response.headers['Location'] == 'http://localhost/articles_by_date?date=20149&view_comments_for=2'
